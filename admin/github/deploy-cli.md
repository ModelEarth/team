<h1 class="card-title">How to push/pull changes</h1>
...
<pre><code>pull using team/AGENTS.md guidance with git.sh</code></pre>

Afterwards, you just "push" to deploy changes.

	push

Note: Using "push" will "pull" first, so you don't overwrite.  
"push" also sends a Pull Request (PR) unless you include "nopr"

If "push" is asking for multiple approvals, your CLI isn't following the AGENTS.md instructions.
